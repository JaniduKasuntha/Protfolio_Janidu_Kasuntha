  ...
  return (
    <section id="testimonials" className="py-24 md:py-32 relative overflow-hidden bg-background">
      ...
      <div className="container mx-auto max-w-7xl px-6 relative z-10">
        ...
        {/* Category Tabs */}
        <div className="flex justify-center gap-3 mb-14 animate-fade-in animation-delay-100">
          <button
            ...
            >
              ...
              <div className="space-y-4">
                {achievements.map((item) => (
                  <div
                    key={item.id}
                    className="glass-card rounded-2xl p-5 sm:p-6 border border-white/5 hover:border-primary/40 transition-all duration-300 group shadow-md"
                  >
