      ...
      <div className="container mx-auto max-w-7xl px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-6 space-y-6">
            ...
            {/* Quick Metrics Grid with Stagger */}
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {highlights.map((item, idx) => (
                <Reveal key={idx} delay={150 + idx * 80}>
                  <div className="glass rounded-xl p-4 text-center border border-white/5 hover:border-primary/30 transition-colors">
          ...
          {/* Right Column - 4 Engineering Pillars with Stagger (6 cols) */}
          <div className="lg:col-span-6 grid sm:grid-cols-2 gap-4">
            {pillars.map((pillar, idx) => (
              <Reveal key={idx} delay={120 + idx * 90}>
                <div className="glass-card p-6 rounded-2xl border border-white/5 hover:border-primary/40 transition-all duration-300 group hover:-translate-y-1 h-full flex flex-col justify-between">
                  <div>
