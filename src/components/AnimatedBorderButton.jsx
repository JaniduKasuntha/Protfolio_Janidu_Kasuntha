export const AnimatedBorderButton = ({ children, as: Component = "button", className = "", ...props }) => {
  return (
    <Component
      className={`relative inline-flex items-center justify-center bg-transparent border border-border 
        text-foreground hover:border-primary/50 transition-all 
        duration-300 active:scale-95 active:duration-75 focus:outline-none focus-visible:ring-2 
